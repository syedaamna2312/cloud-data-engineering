...
OVER(PARTITION BY s.store_name ORDER BY o.order_date) AS running_total
FROM retailmart.orders o
JOIN retailmart.stores s ON s.store_id = o.store_id
JOIN retailmart.order_items oi ON oi.order_id = o.order_id
...
FROM retailmart.orders o
JOIN retailmart.customers c ON c.customer_id = o.customer_id
JOIN retailmart.stores s ON s.store_id = o.store_id;
...
AS
BEGIN
SELECT MONTH(o.order_date) AS SalesMonth,
